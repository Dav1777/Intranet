...
(
    ...
    funcionario_id   NUMBER(38, 0), -- Coluna adicionada/confirmada
...
-- RESTRIÇÃO CORRIGIDA: funcionario_id em chamados referencia id em funcionario
ALTER TABLE chamados
